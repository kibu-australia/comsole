...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj43378 = {};return obj43378;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3548__auto__ = this$;if(and__3548__auto__)
...
{var x__4187__auto__ = (((this$ == null))?null:this$);return (function (){var or__3560__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4187__auto__)]);if(or__3560__auto__)
{return or__3560__auto__;
} else
{var or__3560__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3560__auto____$1)
...
return (function (p__43379){var vec__43380 = p__43379;var k = cljs.core.nth.call(null,vec__43380,(0),null);var v = cljs.core.nth.call(null,vec__43380,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__43381){var vec__43382 = p__43381;var k = cljs.core.nth.call(null,vec__43382,(0),null);var v = cljs.core.nth.call(null,vec__43382,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
