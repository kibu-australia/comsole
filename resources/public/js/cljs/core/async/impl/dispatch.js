...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_47794 = (0);while(true){
var m_47795 = cljs.core.async.impl.dispatch.tasks.pop();if((m_47795 == null))
{} else
{m_47795.call(null);
if((count_47794 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__47796 = (count_47794 + (1));
count_47794 = G__47796;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3548__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3548__auto__)
